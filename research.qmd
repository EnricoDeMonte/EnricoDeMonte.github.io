...
![Regularized solution path of the Landweber-Fridman procedure](Images/regularized_solution_path.PNG){width=70%}
...
![Empirical PDF of firm-level productivity of exporter and non-exporter](Images/Exporter_vs_domestic_TFP.png){width=70%}
...
>
> Further results presented in the paper show that fixed and variable costs are inversaly related: larger firms have higher fixed costs and lower marginal costs. We then use parameter estimates of the empirical cost and demand function to simulate under which conditions welfare is maximized both in the short- and in the long-run. 

![Estimated distribution of unobserved fixed cost heterogeneity](Images/Fig_dens_gam_f.PNG){width=70%}

![Estimated distribution of unobserved variable cost heterogeneity](Images/Fig_dens_gam_v.PNG){width=70%}

</details>

# Work in progress

Business dynamism and high-growth firms in Germany (with J. Miranda)

Evidence on Merger and Acquisitions (with J. Miranda, S. Murmann, V. Plümpe) 

From Legal Units to Firms: A Hybrid Approach to Ownership-Based and Name-Based Firm Identification (with V. Plümpe, J. Miranda, L. Holste, and J. Wang) 

Patenting Activity in Germany across Inventors and Firms (with A. Alam, A. Diegmann, J. Miranda, V. PlÜmpe) 
